...
//                actionBar.setTitle(LocaleController.getString("AppName", R.string.AppName)); TODO this will always return old AppName "Telegram"
                actionBar.setTitle(actionBar.getContext().getString(R.string.AppName));
            }
        }
